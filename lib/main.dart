...
// import 'package:bkid_frontend/batolPages/CreateTaskScreen.dart';
...
import 'package:bkid_frontend/batolPages/AddGoalsDialog.dart';
import 'package:bkid_frontend/batolPages/GoalsManagingScreenState.dart';
import 'package:bkid_frontend/batolPages/GoalsManagingScreen.dart' as screen;
import 'package:bkid_frontend/batolPages/CreateTaskScreen.dart'; // Import CreateTaskScreen
  ...
  Widget build(BuildContext context) {
    final GoRouter router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          path: '/goals-managing',
          builder: (context, state) => screen.GoalsManagingScreen(),
        ),
        GoRoute(
          path: '/create-kid',
          builder: (context, state) => CreateKidPage(),
        ...
        GoRoute(
          path: '/create-task',
          builder: (context, state) =>
              CreateTaskScreen(), // Add route for CreateTaskScreen
        ),
      ],
    );
